...
1. Go to the [Security tab](https://github.com/kkm-horikawa/wagtail-asset-publisher/security) of this repository
...
When using wagtail-asset-publisher:

1. Always use the latest version
2. Keep your Wagtail and Django installations up to date
3. Follow Wagtail's security recommendations
4. Validate and sanitize user input in custom asset builder implementations
